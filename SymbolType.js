...
alert(user[id3]);
for (key in user){
    alert(user[key])//sham 21 id3 value is not displayed
};
//ex2
let id4=Symbol();
let user1={
...
alert(user2[id5]);//11
//Object.keys() :It displays the string keys in the object but does not display symbol keys
let id6=Symbol();
let user3={
    lastName:'ghana',
    age:21,
...
alert(Object.keys(user3));//lastName,age
//Object.assign() : copy
let id7=Symbol();
let user4={
    name:'hello',
...
alert(copy[id7]);//321
alert(copy.name);//helo
alert(Object.keys(user4));//name
//Symbol()
let id01=Symbol('f');
let id02=Symbol('f');
alert(id01==id02);*/
...
alert(id03==id04);
alert(id04.toString());// view symbol :symbol(f)
//Symbol.keyFor()  Symbol.keyFor() works with Symbol.for(), but not with Symbol()
alert(Symbol.keyFor(id04));// view name :f
